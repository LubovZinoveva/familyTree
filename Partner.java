public class Partner extends Person{
    ...
    public Partner(Integer id, String fName, String sName, String gender, String birthDate, Boolean status,
    ...
    @Override
    public void Hello() {
        System.out.println("Привет, я супруг(а). Меня зовут " + getfName());
    }
}
